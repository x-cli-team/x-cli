...
function LogoMark() {
  return (
    <div className="flex items-center gap-2">
      <div className="h-8 w-8 bg-white rounded-lg flex items-center justify-center text-black font-bold">
        G
      </div>
      <span className="text-white font-semibold text-xl">grok-cli</span>
    </div>
  );
}